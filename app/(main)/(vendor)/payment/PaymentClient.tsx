...
const PaymentClient: React.FC<PaymentClientProps> = ({ bookings, paginationMeta }) => {
        ...
        <>
            {bookings.length === 0 ? (
                <div className="mt-8 rounded-lg border-2 border-dashed border-border bg-card py-20 text-center">
                    <p className="text-xl font-semibold text-foreground">No Payment Records found</p>
                    <p className="text-muted-foreground">Try making a payment first</p>
                </div>
            ) : (
